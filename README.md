# Spice Lane Restaurant — Demo Site

Sample portfolio project by [Chandhini Software Solutions LLC](https://chandhini.com).
A sample portfolio demo of a local restaurant website built by Chandhini Software Solutions LLC.
...
- Custom subdomain configured via `CNAME` file: `restaurant.chandhini.com`
- DNS: add a CNAME record at the registrar pointing
  `restaurant` → `bayina.github.io`.
